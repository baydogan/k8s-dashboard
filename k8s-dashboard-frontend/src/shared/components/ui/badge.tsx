...
const variants: Record<BadgeVariant, string> = {
  default: "bg-bg-raised border-border text-text",
  success: "bg-accent/10 border-accent/30 text-accent",
  warning: "bg-accent-warn/10 border-accent-warn/30 text-accent-warn",
  critical: "bg-accent-crit/10 border-accent-crit/30 text-accent-crit",
  ...
  return (
    <span
      className={cn(
        ...
        "border text-[10px] font-mono font-medium tracking-wide uppercase",
        "rounded-sm",
        variants[variant],
        className
      )}

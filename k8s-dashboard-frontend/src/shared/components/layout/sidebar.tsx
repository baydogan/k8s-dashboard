  ...
  const groups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: t("items.ingressClasses"),  href: `${base}/ingress-classes`,  icon: Layers  },
        { label: t("items.endpoints"),       href: `${base}/endpoints`,        icon: Plug    },
        { label: t("items.endpointSlices"),  href: `${base}/endpoint-slices`,  icon: Plug2   },
      ],
    },
    {
      label: t("groups.gateway"),
      items: [
        { label: t("items.gateways"),               href: `${base}/gateways`,               icon: Waypoints },
        { label: t("items.gatewayClasses"),         href: `${base}/gateway-classes`,        icon: Tag       },
        { label: t("items.httpRoutes"),             href: `${base}/http-routes`,            icon: Route     },
        { label: t("items.grpcRoutes"),             href: `${base}/grpc-routes`,            icon: Zap       },
        { label: t("items.referenceGrants"),        href: `${base}/reference-grants`,       icon: LinkIcon  },
        { label: t("items.backendTlsPolicies"),     href: `${base}/backend-tls-policies`,   icon: Shield    },
        { label: t("items.backendTrafficPolicies"), href: `${base}/backend-traffic-policies`,icon: Sliders  },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { label: t("items.roleBindings"),        href: `${base}/role-bindings`,         icon: LinkIcon    },
        { label: t("items.clusterRoles"),        href: `${base}/cluster-roles`,         icon: Shield      },
        { label: t("items.clusterRoleBindings"), href: `${base}/cluster-role-bindings`, icon: Link2       },

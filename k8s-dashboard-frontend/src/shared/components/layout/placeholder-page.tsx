...
export function PlaceholderPage({
  ...
  description = "This section is scaffolded. Implementation coming in the next phase.",
          ...
          <div className="mt-10 w-full max-w-md bg-bg-sunken border border-border rounded-sm overflow-hidden">
            ...
            <div className="p-3 font-mono text-xs space-y-1">
              <div className="text-text-muted">
                <span className="text-accent">$</span> observer status --feature {title.toLowerCase()}
              </div>
              <div className="text-text-dim pl-2">
                → feature: <span className="text-accent-warn">SCAFFOLDED</span>
              </div>
              <div className="text-text-dim pl-2">
                → backend: <span className="text-accent-warn">PENDING</span>
              </div>
              <div className="text-text-dim pl-2">
                → ui: <span className="text-accent">READY</span>
